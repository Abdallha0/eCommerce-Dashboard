          ...
          {navItems.map((item) => {
            ...
            return (
              <Link
                ...
                className={`flex items-center gap-3 rounded-2xl px-4 py-3 text-sm font-medium transition-colors ${active.includes(item.href) ? "bg-slate-100 dark:bg-slate-800/80" : "hover:bg-slate-100 dark:hover:bg-slate-800/80"}`}
              >
